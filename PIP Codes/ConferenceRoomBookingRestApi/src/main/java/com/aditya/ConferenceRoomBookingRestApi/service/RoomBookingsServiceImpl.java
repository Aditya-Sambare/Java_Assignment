    ...
    public ResponseEntity addRoomBooking(BookingDto bookingDto) {
        ...
        if (roomBookingsList.size()==0){
            ...
            for(int i = 0; i < roomBookingsList.size(); i++){
                if((roomBookings.getStartingTime().after(roomBookingsList.get(i).getStartingTime()) && roomBookings.getStartingTime().before(roomBookingsList.get(i).getEndingTime())) ||(roomBookings.getEndingTime().after(roomBookingsList.get(i).getStartingTime()) && roomBookings.getEndingTime().before(roomBookingsList.get(i).getEndingTime())) ||(roomBookings.getStartingTime().before(roomBookingsList.get(i).getStartingTime())&& roomBookings.getEndingTime().after(roomBookingsList.get(i).getEndingTime())))
                {
