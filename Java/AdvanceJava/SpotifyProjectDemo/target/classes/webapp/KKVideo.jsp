<%@page import="DataBaseConnectionDAO.ConnectionProvider,java.io.IOException,java.sql.*,javax.servlet.*,javax.servlet.http.*"%>
<html>
<head></head>
<style>
    body{
...
<%
         ...
         try{
             PreparedStatement preparedStatement = connection.prepareStatement("select * from kk_video");
