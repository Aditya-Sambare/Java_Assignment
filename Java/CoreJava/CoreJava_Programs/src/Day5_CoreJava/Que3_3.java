...
public class Que3_3 {
    public static void main(String[] args) {
        System.out.println(" Java main() method is always static, so that compiler can call it without the creation of an object or before the creation of an object of the class. ");
    }
}
//--------------------------------------------------------------
//        output is
